#!/usr/bin/env bash
# Laplace on an annulus: does an AMR hierarchy match the uniform grid whose
...
#   python3 amr_error.py -f uni128 uni256 uni512
#   python3 amr_error.py -f amr32 amr64 amr128
#
